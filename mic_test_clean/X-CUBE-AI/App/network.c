...
#define AI_NETWORK_MODEL_SIGNATURE     "0x9a0ebb6d0a64c94c4a8ffcf253445a5c"
...
#define AI_TOOLS_DATE_TIME   "2026-04-16T19:43:08+0200"
...
AI_INTQ_INFO_LIST_OBJ_DECLARE(conv2d_0_output_array_intq, AI_STATIC_CONST,
  ...
  AI_PACK_INTQ_INFO(
    AI_PACK_INTQ_SCALE(1.583792805671692f),
    AI_PACK_INTQ_ZP(-128)))
...
AI_INTQ_INFO_LIST_OBJ_DECLARE(conv2d_0_weights_array_intq, AI_STATIC_CONST,
  ...
  AI_PACK_INTQ_INFO(
    AI_PACK_INTQ_SCALE(0.0016120027285069227f, 0.0026264102198183537f, 0.0015783888520672917f, 0.0025604369584470987f, 0.002373813884332776f, 0.0011644003679975867f, 0.001855888869613409f, 0.0017938801320269704f),
...
AI_INTQ_INFO_LIST_OBJ_DECLARE(conv2d_2_output_array_intq, AI_STATIC_CONST,
  AI_BUFFER_META_FLAG_SCALE_FLOAT|AI_BUFFER_META_FLAG_ZEROPOINT_S8, 1,
  AI_PACK_INTQ_INFO(
    AI_PACK_INTQ_SCALE(0.4423426389694214f),
    AI_PACK_INTQ_ZP(-128)))
...
AI_INTQ_INFO_LIST_OBJ_DECLARE(conv2d_2_weights_array_intq, AI_STATIC_CONST,
  ...
  AI_PACK_INTQ_INFO(
    AI_PACK_INTQ_SCALE(0.003495230572298169f, 0.0029576874803751707f, 0.004326323047280312f, 0.0031091715209186077f, 0.0025041443295776844f, 0.0033803966362029314f, 0.0031152544543147087f, 0.0030123000033199787f, 0.0025441863108426332f, 0.0029207889456301928f, 0.00401171064004302f, 0.0026656214613467455f, 0.003990058787167072f, 0.002562494482845068f, 0.0032220687717199326f, 0.002677778946235776f),
...
AI_INTQ_INFO_LIST_OBJ_DECLARE(gemm_8_output_array_intq, AI_STATIC_CONST,
  AI_BUFFER_META_FLAG_SCALE_FLOAT|AI_BUFFER_META_FLAG_ZEROPOINT_S8, 1,
  AI_PACK_INTQ_INFO(
    AI_PACK_INTQ_SCALE(0.4261041581630707f),
    AI_PACK_INTQ_ZP(-128)))
...
AI_INTQ_INFO_LIST_OBJ_DECLARE(gemm_8_weights_array_intq, AI_STATIC_CONST,
  ...
  AI_PACK_INTQ_INFO(
    AI_PACK_INTQ_SCALE(0.003075661603361368f, 0.003472390817478299f, 0.0011798000195994973f, 0.00093513895990327f, 0.0040404219180345535f, 0.0032724349293857813f, 0.00217117415741086f, 0.0014621575828641653f, 0.0032416300382465124f, 0.0017818842316046357f, 0.00242943805642426f, 0.0012766038998961449f, 0.0034090697299689054f, 0.004436314571648836f, 0.001524319057352841f, 0.00375978066585958f, 0.0037214087788015604f, 0.004491070751100779f, 0.0014079243410378695f, 0.00418712105602026f, 0.0008768811239860952f, 0.0013114754110574722f, 0.0036598059814423323f, 0.0017631204100325704f),
...
AI_INTQ_INFO_LIST_OBJ_DECLARE(gemm_9_output_array_intq, AI_STATIC_CONST,
  AI_BUFFER_META_FLAG_SCALE_FLOAT|AI_BUFFER_META_FLAG_ZEROPOINT_S8, 1,
  AI_PACK_INTQ_INFO(
    AI_PACK_INTQ_SCALE(0.27553921937942505f),
    AI_PACK_INTQ_ZP(-116)))
...
AI_INTQ_INFO_LIST_OBJ_DECLARE(gemm_9_weights_array_intq, AI_STATIC_CONST,
  ...
  AI_PACK_INTQ_INFO(
    AI_PACK_INTQ_SCALE(0.003486836329102516f, 0.00431433878839016f, 0.003424911992624402f),
...
AI_INTQ_INFO_LIST_OBJ_DECLARE(serving_default_keras_tensor0_output_array_intq, AI_STATIC_CONST,
  AI_BUFFER_META_FLAG_SCALE_FLOAT|AI_BUFFER_META_FLAG_ZEROPOINT_S8, 1,
  AI_PACK_INTQ_INFO(
    AI_PACK_INTQ_SCALE(4.5742292404174805f),
    AI_PACK_INTQ_ZP(-86)))
...
AI_TENSOR_OBJ_DECLARE(
  ...
  1, 0x1,
  AI_SHAPE_INIT(4, 1, 8, 6, 49), AI_STRIDE_INIT(4, 1, 1, 8, 48),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  6, 0x1,
  AI_SHAPE_INIT(4, 1, 16, 3, 24), AI_STRIDE_INIT(4, 1, 1, 16, 48),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  9, 0x1,
  AI_SHAPE_INIT(4, 1, 16, 6, 2), AI_STRIDE_INIT(4, 1, 1, 16, 96),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  13, 0x0,
  AI_SHAPE_INIT(4, 1, 1272, 1, 1), AI_STRIDE_INIT(4, 2, 2, 2544, 2544),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  14, 0x1,
  AI_SHAPE_INIT(4, 1152, 24, 1, 1), AI_STRIDE_INIT(4, 1, 1152, 27648, 27648),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  17, 0x0,
  AI_SHAPE_INIT(4, 1, 39, 1, 1), AI_STRIDE_INIT(4, 2, 2, 78, 78),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  18, 0x1,
  AI_SHAPE_INIT(4, 24, 3, 1, 1), AI_STRIDE_INIT(4, 1, 24, 72, 72),
...
AI_STATIC_CONST ai_i32 nl_10_nl_params_data[] = { 1183431936, 25, -62 };
AI_ARRAY_OBJ_DECLARE(
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 29148, 1, 1),
    29148, NULL, NULL),
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 5488, 1, 1),
    5488, NULL, NULL),
  ...
  &conv2d_0_layer, 0x5ef17fd3, NULL)
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(g_network_activations_map, 1, params)) {
    ...
    serving_default_keras_tensor0_output_array.data = AI_PTR(g_network_activations_map[0] + 2980);
    serving_default_keras_tensor0_output_array.data_start = AI_PTR(g_network_activations_map[0] + 2980);
    conv2d_0_scratch0_array.data = AI_PTR(g_network_activations_map[0] + 2688);
    conv2d_0_scratch0_array.data_start = AI_PTR(g_network_activations_map[0] + 2688);
    conv2d_0_scratch1_array.data = AI_PTR(g_network_activations_map[0] + 2480);
    conv2d_0_scratch1_array.data_start = AI_PTR(g_network_activations_map[0] + 2480);
    conv2d_0_output_array.data = AI_PTR(g_network_activations_map[0] + 128);
    conv2d_0_output_array.data_start = AI_PTR(g_network_activations_map[0] + 128);
    conv2d_2_scratch0_array.data = AI_PTR(g_network_activations_map[0] + 2480);
    conv2d_2_scratch0_array.data_start = AI_PTR(g_network_activations_map[0] + 2480);
    conv2d_2_scratch1_array.data = AI_PTR(g_network_activations_map[0] + 5296);
    conv2d_2_scratch1_array.data_start = AI_PTR(g_network_activations_map[0] + 5296);
    ...
    gemm_8_scratch0_array.data = AI_PTR(g_network_activations_map[0] + 1152);
    gemm_8_scratch0_array.data_start = AI_PTR(g_network_activations_map[0] + 1152);
    gemm_8_output_array.data = AI_PTR(g_network_activations_map[0] + 3696);
    gemm_8_output_array.data_start = AI_PTR(g_network_activations_map[0] + 3696);
    ...
    gemm_9_output_array.data = AI_PTR(g_network_activations_map[0] + 80);
    gemm_9_output_array.data_start = AI_PTR(g_network_activations_map[0] + 80);
    nl_10_scratch0_array.data = AI_PTR(g_network_activations_map[0] + 84);
    nl_10_scratch0_array.data_start = AI_PTR(g_network_activations_map[0] + 84);
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(g_network_weights_map, 1, params)) {
    ...
    gemm_8_bias_array.data = AI_PTR(g_network_weights_map[0] + 28968);
    gemm_8_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 28968);
    gemm_9_weights_array.format |= AI_FMT_FLAG_CONST;
    gemm_9_weights_array.data = AI_PTR(g_network_weights_map[0] + 29064);
    gemm_9_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 29064);
    gemm_9_bias_array.format |= AI_FMT_FLAG_CONST;
    gemm_9_bias_array.data = AI_PTR(g_network_weights_map[0] + 29136);
    gemm_9_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 29136);
    return true;
  }
